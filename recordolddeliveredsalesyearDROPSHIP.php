<?php
	...
	$sql = "select a.order_id
			  from oc_order a
			 where a.payment_confirmed_date >= '2020-01-01 00:00:00' 
			   and a.payment_confirmed_date <= '2020-09-29 23:59:59'";
	$query = $db->query($sql);	
	$sales_year = $query->rows;
				
	foreach($sales_year as $sy) {
				...
				if($do['user_group_id'] == 56 and $do['send_to'] == 110) {
					...
					if($total_delivered == 0)	{
						...
						$sql ="update oc_sales_delivered
								  set sales_year = sales_year + ". $do['amount']."
