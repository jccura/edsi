<?php
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id > 0 
			   ...
			   and a.encoded_date >= '2020-09-27 00:00:00' 
			   and a.encoded_date <= '2020-09-27 23:59:59'";
	$query = $db->query($sql);	
	$sales_encoded_3rd_day = $query->rows;
				
	foreach($sales_encoded_3rd_day as $se3) {
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id > 0 
			   ...
			   and a.encoded_date <= '2020-09-28 23:59:59' ";
	$query = $db->query($sql);	
	$sales_encoded_2nd_day = $query->rows;
				
	foreach($sales_encoded_2nd_day as $se2) {
		//kunin ang details ng order
		$sql = "select a.order_id,b.item_id,d.user_group_id,c.price * b.quantity amount,b.quantity,a.user_id
					  ,d.user_group_id,a.send_to,a.delivery_fee,a.discount
					  ,ROUND(c.distributor_discount_per / 100 * c.price * b.quantity, 2)discount_dist
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id > 0 
			   and a.status_id not in(19,113) 
			   and a.encoded_date >= '2020-09-29 00:00:00' 
			   and a.encoded_date <= '2020-09-29 23:59:59' ";
	$query = $db->query($sql);	
	$sales_yesterday = $query->rows;
				
	foreach($sales_yesterday as $sy) {
		//kunin ang details ng order
		$sql = "select a.order_id,b.item_id,d.user_group_id,c.price * b.quantity amount,b.quantity,a.user_id
					  ,d.user_group_id,a.send_to,a.delivery_fee,a.discount
					  ,ROUND(c.distributor_discount_per / 100 * c.price * b.quantity, 2)discount_dist
