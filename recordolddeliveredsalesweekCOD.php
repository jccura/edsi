<?php
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (35) 
			   ...
			   and a.actual_delivery_date >= '2020-09-07 00:00:00' 
			   and a.actual_delivery_date <= '2020-09-13 23:59:59'";
	$query = $db->query($sql);	
	$sales_third_week = $query->rows;
				
	foreach($sales_third_week as $sw3) {
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (35) 
			   and a.payment_option in (148,146,157,158) 
			   and a.actual_delivery_date >= '2020-09-14 00:00:00' 
			   and a.actual_delivery_date <= '2020-09-20 23:59:59'";
	$query = $db->query($sql);	
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (35) 
			   and a.payment_option in (148,146,157,158) 
			   and a.actual_delivery_date >= '2020-09-21 00:00:00' 
			   and a.actual_delivery_date <= '2020-09-27 23:59:59' ";
	$query = $db->query($sql);	
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (35) 
			   and a.payment_option in (148,146,157,158) 
			   and a.actual_delivery_date >= '2020-09-28 00:00:00' 
