<?php
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-06-01 00:00:00' 
			   and a.pickedup_date <= '2020-06-30 23:59:59'";
	$query = $db->query($sql);	
	...
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-07-01 00:00:00' 
			   and a.pickedup_date <= '2020-07-31 23:59:59'";
	$query = $db->query($sql);	
	...
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-08-01 00:00:00' 
			   and a.pickedup_date <= '2020-08-31 23:59:59' ";
	$query = $db->query($sql);	
	...
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-09-01 00:00:00' 
