<?php
	...
	//sales 3rd week delivered
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-09-07 00:00:00' 
			   and a.pickedup_date <= '2020-09-13 23:59:59'";
	$query = $db->query($sql);	
	$sales_delivered_3rd_week = $query->rows;
				
	foreach($sales_delivered_3rd_week as $sw3) {
	...
	//sales 2nd week delivered
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-09-14 00:00:00' 
			   and a.pickedup_date <= '2020-09-20 23:59:59'";
	$query = $db->query($sql);	
	$sales_delivered_2nd_week = $query->rows;
				
	foreach($sales_delivered_2nd_week as $sw2) {
		//kunin ang details ng order
		$sql = "select a.order_id,b.item_id,d.user_group_id,c.price * b.quantity amount,b.quantity,a.user_id
					  ,d.user_group_id,a.send_to,a.delivery_fee,a.discount
					  ,ROUND(c.distributor_discount_per / 100 * c.price * b.quantity, 2)discount_dist
...
//sales prev week delivered
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (152) 
			   and a.pickedup_date >= '2020-09-21 00:00:00' 
			   and a.pickedup_date <= '2020-09-27 23:59:59'";
	$query = $db->query($sql);	
	$sales_delivered_prev_week = $query->rows;
				
	foreach($sales_delivered_prev_week as $sp) {
		//kunin ang details ng order
		$sql = "select a.order_id,b.item_id,d.user_group_id,c.price * b.quantity amount,b.quantity,a.user_id
					  ,d.user_group_id,a.send_to,a.delivery_fee,a.discount
					  ,ROUND(c.distributor_discount_per / 100 * c.price * b.quantity, 2)discount_dist
...
//sales this week delivered
	...
	$query = $db->query($sql);	
	$sales_delivered_this_week = $query->rows;
				
	foreach($sales_delivered_this_week as $sw) {
		//kunin ang details ng order
		$sql = "select a.order_id,b.item_id,d.user_group_id,c.price * b.quantity amount,b.quantity,a.user_id
					  ,d.user_group_id,a.send_to,a.delivery_fee,a.discount
					  ,ROUND(c.distributor_discount_per / 100 * c.price * b.quantity, 2)discount_dist
