<?php
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (35)  
			   ...
			   and a.actual_delivery_date >=  '2020-09-27 00:00:00'  
...
//sales 2nd day delivered
	$sql = "select a.order_id
			  from oc_order a
			 where a.status_id in (35)  
			   and a.payment_option in (148,146,157,158)
			   and a.actual_delivery_date >= '2020-09-28 00:00:00' 
			   and a.actual_delivery_date <= '2020-09-28 23:59:59'";
	$query = $db->query($sql);	
	...
	$sql = "select a.order_id
			 ...
			 where a.status_id in (35)  
			   and a.payment_option in (148,146,157,158)
			   and a.actual_delivery_date >= '2020-09-29 00:00:00' 
