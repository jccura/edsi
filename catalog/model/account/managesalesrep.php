<?php
class ModelAccountManageSalesRep extends Model {
	
	public function getSalesRepDetails($data){
	...
	public function addNewSalesRep($data){
		...
		return "Sales Representative Registration Successful";
	}
	
	public function updateSalesRepDetails($data){
		// var_dump($data);
		$password = "";
		...
		return "Successful Updating Sales Representative Details.";
		
	}
	
	public function disableSalesRep($data){
		...
		$this->db->query($sql);
		return "Successful Disabling of Sales Representative (".$username.")";

	}
	
	public function enableSalesRep($data){
		...
		$sql .= "   WHERE user_id = '".$data['user_id']."' ";
		$this->db->query($sql);
		return "Successful Enabling of Sales Representative (".$username.")";
	...
	public function getSalesRep($data, $query_type = "data") {
