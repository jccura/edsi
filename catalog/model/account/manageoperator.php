<?php
class ModelAccountManageOperator extends Model {
	
	public function getOperatorDetails($data){
	...
	public function addNewOperator($data){
		...
		return "Operator Registration Successful";
	}
	
	public function updateOperatorDetails($data){
		//var_dump($data);
		$password = "";
	...
	public function disableOperator($data){
		...
		$this->db->query($sql);
		return "Successful Disabling of Operator (".$username.")";

	}
	
	public function enableOperator($data){
		...
		$sql .= "   WHERE user_id = '".$data['user_id']."' ";
		$this->db->query($sql);
		return "Successful Enabling of Operator (".$username.")";
	...
	public function getOperator($data, $query_type = "data") {
