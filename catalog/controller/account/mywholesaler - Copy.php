...
class ControllerAccountMywholesaler extends Controller {
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'GET')) {
			...
			$this->data['unilevel_list'] = $this->model_account_customers->getGeneologyList($i_user_id,$this->request->get);			
			...
			$this->data['unilevel_list'] = $this->model_account_customers->getGeneologyList($i_user_id,$this->request->post);			
