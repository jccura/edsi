<?php   
class ControllerAccountMySerials extends Controller {   
	
	public function index() {
		
		if (!$this->user->isLogged() or !($this->user->checkScreenAuth($this->user->getUserGroupId(), 'myserials'))) {
		...
		$this->data['myserials'] = $this->model_account_inventory->getMySerials($data, "data");
		$total = $this->model_account_inventory->getMySerials($data, "total");	
		...
		$pagination->url = 'myserials/{page}';
			
		$this->data['pagination'] = $pagination->render();	
		
		$this->template = 'default/template/account/myserials.tpl';
		$this->children = array(
			'common/column_left',
			'common/footer',
			'common/header'	
