	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
			<i class="ni ni-box-2 ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp; Delivered</h6>
		</div>
	  </div>
	</div>
  </div>
								...
								<center>
									<!--<div class="template-demo">-->
										<div class="row">
											...
											<!--<div class="col-md-3">
												<button class="btn btn-outline-success btn-block" type="button" onclick="javascript: performTask('tagpaymentremitted');"><i class="fa fa-list"></i> Tag as Payment Remitted</button>
												<br/>
											</div>-->
										</div>
									<!--</div>-->
...
function performTask(task) {
	...
	$('#task').val(task);
	$('form').attr('action', 'paymentdelivered'); 
	$('form').submit();
