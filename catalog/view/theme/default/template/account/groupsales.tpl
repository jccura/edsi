	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
			<h6 class="h1 text-white d-inline-block mb-0">&nbsp; Network Groupsales</h6>
		</div>
	  </div>
	</div>
  </div>
		...
		<div class="col-xl-4 col-md-4">
			<div class="card btn-outline-upper border-0">
				<div class="card-body">
					<div class="row">
						<div class="col-md-12 text-center">
							<h1 class="card-title text-uppercase text-muted mb-0 text-white">Php <?php echo number_format ($total_groupsales,2); ?></h1>
							<h5 class="card-title text-uppercase text-muted mb-0 text-white">Total GroupSales</h5>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="card card bg-default shadow">
									...
									<div class="table-responsive">			
										<table class="table align-items-center table-dark table-flush">
											...
											<tbody>
											<?php if (isset($unilevel_sales)) { ?>
												<?php foreach ($unilevel_sales as $uni) { ?>
													<tr>
