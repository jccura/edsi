		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				<div class="col-lg-6 col-7">
					<i class="ni ni-bag-17 ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp;&nbsp;My Sales Delivered</h6>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="table-responsive">
				<table class="table align-items-center table-flush">
					...
					<tbody class="list">	
						<?php if (isset($salesdelivered)) { ?>
							<?php foreach ($salesdelivered as $sd) { ?>
								<tr>
									<td><?php echo $sd['sales_delivered_id'];?></td>
									<td><?php echo $sd['item_name'];?></td>
									<td><?php echo "Php ".number_format($sd['sales_today'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_yesterday'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_second_day'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_third_day'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_week'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['prev_week'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_second_week'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_third_week'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_month'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['prev_month'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_second_month'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_third_month'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_year'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['prev_year'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_second_year'], 2);?></td>
									<td><?php echo "Php ".number_format($sd['sales_third_year'], 2);?></td>
									<td><?php echo $sd['date_added'];?></td>
								</tr>
							<?php } ?>	
						<?php } ?>				
					</tbody>
