		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				<div class="col-lg-6 col-7">
				  <i class="ni ni-building ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp;&nbsp;Admin Sales Encoded</h6>
				</div>
			</div>
		</div>
	</div>
				...
				<form action="" method="post" enctype="multipart/form-data" id="form">
					...
					<div class="card">
						...
						<div class="card-header border-0">
							<div class="row">
								<div class="col-6">
									<h3 class="mb-0">List of Admin's Sales Encoded</h3>
								</div>
						...
						<div class="table-responsive">
							<table class="table align-items-center table-flush">
								<thead class="thead-light">
									<tr>
										<th class="left">Sales Encoded ID</th>
										<th class="left">Username</th>
										<th class="left">Item Name</th>
										<th scope="col">Today</th>
										<th scope="col">Yesterday</th>
										<th scope="col">2nd Day</th>
										<th scope="col">3rd Day</th>
								...
								<tbody>
									<?php if (isset($admin_sales)) { ?>								
									   ...
									   <tr>
											<td><?php echo $admin_sale['sales_encoded_id'];?></td>
...
function updateAdminDetails() {
  ...
  $('form').attr('action', "adminsalesmonitoring"); 
  $('form').submit();
  }
  ...
  $.ajax({
    ...
    success: function(json) {             
      if (json['status'] == "success") {
        ...
        $("#modal-button-admin").html("<button type=\"button\" class=\"btn bg-avgreen text-white\" onclick=\"updateAdminDetails()\" ><i class=\"fa fa-floppy-o\"></i> Update Admin</button>");
...
function addNewAdminShow(){
  ...
  $("#cust_address").val("");
  $("#modal-button-admin").html("<button type=\"button\" class=\"btn bg-avgreen text-white\" onclick=\"addNewAdmin(47);\" ><i class=\"fa fa-plus\"></i> Add Admin</button>");
