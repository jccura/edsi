	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
		  <i class="ni ni-bag-17 ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp;&nbsp;Distribute Commission</h6>
		</div>
	  </div>
	</div>
  </div>
										...
										<div class="row">
											<div class="col-md-6">
												 <div class="input-group">
													<input class="form-control" placeholder="Order Id" type="text" id="user_id" name="user_id" value=""/>
...
function processTask(task) {
  $('#task').val('submit');
  $('form').attr('action', "distributecomm"); 
  $('form').submit();
}
