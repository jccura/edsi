	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
			<i class="ni ni-delivery-fast ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp; Shipped</h6>
		</div>
	  </div>
	</div>
  </div>
								...
								<center>
									<!--<div class="template-demo">-->
										<div class="row">
											...
											<?php if($this->user->getUserGroupId() == 43) { ?>
												<div class="col-md-3">
													<button class="btn btn-outline-success btn-block" type="button" onclick="javascript: performTask('tagdelivered');"><i class="fa fa-list"></i> Tag as Delivered</button>
													<br/>
												</div>
											<?php } ?>
											<!--<div class="col-md-3">
												<button class="btn btn-outline-danger btn-block" type="button" onclick="javascript: performTask('tagreturned');"><i class="fa fa-list"></i> Tag as Returned</button>
												<br/>
											</div>
											<div class="col-md-3">
												<button class="btn btn-outline-danger btn-block" type="button" onclick="javascript: performTask('cancel');"><i class="fa fa-list"></i> Cancel</button>
												<br/>
											</div>-->
										</div>
									<!--</div>-->
...
function performTask(task) {
	...
	$('#task').val(task);
	$('form').attr('action', 'paymentshipped'); 
	$('form').submit();
