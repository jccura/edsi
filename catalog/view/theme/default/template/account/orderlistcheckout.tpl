	...
	<form action="" method="post" enctype="multipart/form-data" id="form">
		...
		<div class="row">
			<div class="col-sm-12 mb-4 mb-xl-0">
				<h4 class="font-weight-bold text-dark">Check Out</h4>
			</div>
		</div>
								...
								<center>
									<!--<div class="template-demo">-->
										<div class="row">
											...
											<div class="col-md-3">
												<button class="btn btn-outline-warning btn-block" type="button" onclick="javascript: performTask('tagpacked');"><i class="fa fa-list"></i> Tag as Packed</button>
												<br/>
											</div>
											<div class="col-md-3">
...
function performTask(task) {
	...
	$('#task').val(task);
	$('form').attr('action', 'orderlistcheckout'); 
	$('form').submit();
