		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				<div class="col-lg-6 col-7">
					<i class="fa fa-credit-card text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp;&nbsp;Request</h6>
				</div>
			</div>
		</div>
	</div>
		...
		<form action="" method="post" enctype="multipart/form-data" id="form">
			...
			<?php if(!isset($request_id)) { ?>
					...
					<div class="col-md-12">
						<div class="well">
							<div class="row mt-12">			
								...
								<?php if($this->user->getUserGroupId() == 77) { ?>
									<div class="col-md-3">
										<div class="form-group">	
											<select class="form-control" id="branch_id" name="branch_id">
												<option value="">All Branch</option>
												<?php foreach($branch_list as $list){ ?>
												<option value="<?php echo $list['branch_id'] ?>"><?php echo $list['description'] ?></option>
												<?php } ?>
											</select>
										</div>
									</div>
								...
								<div class="col-md-3">
									<div class="form-group">	
										<select class="form-control" id="status_id" name="status_id">
											...
											<option value="72">Requested</option>
											<option value="75">Inventory Confirmed</option>
											<?php if($this->user->getUserGroupId() == 39){?>
											<option value="77">Approved</option>
											<?php }?>
										</select>
									</div>
								</div>
				...
				<div class="row card-margin">						
					...
					<div class="col-md-3">
						<button class="btn btn-primary" type="button" onclick="javascript: creatRequest();"  id="CreateRequest" ><i class="fa fa-exchange"></i> Create Request Inventory</button>&nbsp;&nbsp;
					</div>
					<br><br>
					<div class="col-md-3">
						<button class="btn btn-danger" type="button" onclick="javascript: performTask2('cancelRequest', 'Are you sure you want to cancel selected inventory request?');"  id="CanceRequest" ><i class="fa fa-exchange"></i> Cancel Request Inventory</button>
					</div>		
					<?php } ?>
				</div>
				<br>
									...
									<?php foreach ($requests as $req) { ?>			
										<tr>
										  <td style="text-align: center;">
											<input type="checkbox" name="selected[]" value="<?php echo $req['request_id'];?>"/>
										  </td>
										  <td class="left"><a class="btn btn-success" href="request/<?php echo $req['request_id'];?>" ><i class="fa fa-eye"></i> View</a></td>
										  <td><?php echo $req['status'];?></td>
										  <td>#<?php echo $req['request_id'];?></td>
										  <td><?php echo $req['created_by'];?> (<?php echo $req['creator_fullname'];?>)</td>
										  <td><?php echo $req['payment_option_desc'];?></td>
										  <td><?php echo $req['qty'];?></td>
										  <td><?php echo number_format($req['total_cost'],2);?></td>
										  <td><?php echo $req['qty_on_hand'];?></td>
										  <td><?php echo number_format($req['total_cost_on_hand'],2);?></td>
										  <td><?php echo $req['date_added'];?></td>
										  <td><?php echo $req['approved_by'];?></td>
										  <td><?php echo $req['approval_date'];?></td>
											</tr>
									<?php } ?>
								<?php } ?>
							  </tbody>
