	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
			<i class="ni ni-atom ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp; Processed Orders</h6>
		</div>
	  </div>
	</div>
  </div>
...
<div class="container-fluid mt--6">		
	...
	<?php if($this->user->getUserGroupId() == 47 || $this->user->getUserGroupId() == 12  || $this->user->getUserGroupId() == 56 || $this->user->getUserGroupId() == 46 ) { ?> 
		<div class="row card-margin">

			<div class="col-sm-6 stretch-card">
				<div class="card panel panel-default box_vip_border" style="border-radius: 5px;">
						...
						<div class="card-body bg-gradient-info text-white">
							<div class="row">
								...
								<div class="col-md-9 text-right">
									<div style="font-size:50px;">P <?php echo number_format($total_amount,0);?></div>
									<h4 class="text-white">TOTAL AMOUNT OF ORDERS</h4>
								</div>
					...
					<div class="panel-heading box-vip-dash3">
						<div class="card-body bg-gradient-info text-white">
							<div class="row">
								...
								<div class="col-md-9 text-right">
									<div style="font-size:50px;"><?php echo number_format($total_orders,0);?></div>
									<h4 class="text-white">TOTAL NUMBER OF TRANSACTIONS</h4>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="card">
					<div class="card-body">	
						...
						<div class="row">
							<div class="col-md-12">
								<center>
									<input type="hidden" id="type" name="type" value="processedorders">
			...
			<div class="col">
				<div class="card">
					<div class="card-header border-0">
					  <h3 class="mb-0">Processed List</h3>
					</div>
					<div class="table-responsive">			
						<table class="table align-items-center table-flush">
							<thead class="thead-light">
							<tr class="table-primary">
								<th class="left numeric">&nbsp;</th>
								...
								<th class="text-info">Ship Tracking Number</th>									
								...
								<?php foreach ($orders as $it) { ?>
									<tr>
										<td>
											...
											<?php } else { ?>
												<a class="btn btn-outline-user text-white btn-md" href="trackingpage/<?php echo $it['ref'];?>">View Tracking</a>
											<?php } ?>
										</td>
										<?php if($this->user->getUserGroupId() == 12 or $this->user->getUserGroupId() == 41
												or $this->user->getUserGroupId() == 42 or $this->user->getUserGroupId() == 43) { ?>
...
function performUpdate(action) {
	$('#task').val(action); 
	$('form').attr('action', 'processedorders'); 
	$('form').submit();
}
