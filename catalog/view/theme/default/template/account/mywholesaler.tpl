	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
			<h6 class="h1 text-white d-inline-block mb-0">&nbsp; My Wholesalers</h6>
		</div>
	  </div>
	</div>
  </div>
							...
							<div class="col">
								<div class="card">
									<div class="card-header bg-transparent border-0">
									  <h3 class="mb-0">Wholesalers List</h3>
									</div>
									<div class="table-responsive">			
										<table class="table align-items-center table-flush">
											...
											<tbody>
											<?php if (isset($wholesaler_list)) { ?>
												<?php foreach ($wholesaler_list as $uni) { ?>
													<tr>
														...
														<td>
															<button type="button" class="btn bg-avgreen text-white btn-sm" onclick="addToCartForDownline(<?php echo $uni['dl_user_id'];?>)"><b>Create Order</b></button>
														</td>														
													</tr>
												<?php } ?>	
											<?php } ?>
