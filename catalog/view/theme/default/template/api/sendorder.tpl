	...
	<div class="header-body">
	  <div class="row align-items-center py-4">
		<div class="col-lg-6 col-7">
			<i class="ni ni-send ni-2x text-white"></i><h6 class="h1 text-white d-inline-block mb-0">&nbsp; Send Order</h6>
		</div>
	  </div>
	</div>
  </div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">  
												  <input class="form-control input" type="text" placeholder="" id="order_id" name="order_id">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">  
													<button class="btn btn-success" type="button" onclick="javascript:sendOrderId();" ><i class="fa fa-upload"></i> Send Order</button>
												</div>
											</div>
									  </div>
								  </div>
...
function sendOrderId(){
	// $('#msg').html("Are you sure you want to submit this Order Details?");
	// $(function() {
		// $( "#dialog-message" ).dialog({
		  // modal: true,
		  // width: 600,
		  // buttons: {
			...
			// },
			// Proceed: function() {
				// $('#task').val('sendOrderDetails');
				// $('#form').attr('action', 'sendorder'); 
				// $('#form').submit();
				// $( this ).dialog( "close" );
		...
		// });
	// });
	$('#msg_proceed').html("Are you sure you want to submit this Order Details?");
	$('#div_buttons').html("<button type=\"button\" onclick=\"performTask('sendOrderDetails');\" class=\"btn btn-danger\">Yes, Send it.</button>");		
