...
//sales 3rd day deliveredd
	$sql = "select a.order_id
			  from oc_order a
			 where a.payment_confirmed_date >= '2020-09-27 00:00:00' 
	...
	//sales 2nd day deliveredd
	$sql = "select a.order_id
			  from oc_order a
			 where a.payment_confirmed_date >= '2020-09-28 00:00:00' 
			   and a.payment_confirmed_date <= '2020-09-28 23:59:59'";
	$query = $db->query($sql);	
					...
					if($total_delivered == 0)	{
						$sql ="insert into oc_sales_delivered
								  set user_id = ". $do['user_id']."
									  ...
									  ,discount_per_item = ". $do['discount']."
									  ,date_added ='2020-09-23 12:00:00' ";
						$db->query($sql);
					} else {//if meron nangnakarecord sa sales encoded na user
						$sql ="update oc_sales_delivered
...
//sales yesterday delivered
	$sql = "select a.order_id
			  from oc_order a
			 where a.payment_confirmed_date >= '2020-09-29 00:00:00' 
